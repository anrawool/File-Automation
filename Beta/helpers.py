...
def fetch_timetable(make_file=False):
    s = Service('/Users/abhijitrawool/Documents/Sarthak/Programming_Projects/Automation/Beta/geckodriver')
    ...
    tbody = driver.find_element(By.XPATH, '/html/body/div/div[6]/div/div/div/div[2]/div/div[16]/div/table/tbody')
    for tr in tbody.find_elements(By.XPATH, '//tr'):
        row = [item.text for item in tr.find_elements(By.XPATH, './/td') if item.text != '']
        data.append(row)
