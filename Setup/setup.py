...
class Setup:
    ...
    def initialize(self):
        ...
        if not self.platform in possible_outcomes:
            ...
            print(
                "Please look forward to compatible versions coming out. You can open a issue to the github repository : https://github.com/anrawool/File-Automation stating your request along with your Operting System."
            )
            exit()
        ...
        print("Setting up...")
        permission = input(
            "Please give permission to install python modules in your computer [Y/n]: "
        )
    ...
    def _execute_shell_script_unix(self):
        ...
        self.make_path = input(
            "Please provide the entire path to which you want all your programming projects to be stored in: "
        )
